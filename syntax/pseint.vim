...
syn keyword pseintDoWhile			repetir Repetir
syn keyword pseintEndDoWhile 	hasta que Hasta Que skipwhite skipempty
...
hi def link pseintDoWhile			Repeat
hi def link pseintEndDoWhile	Repeat
